...
SEED_COUPONS = [
    ...
    {'code': 'BARK20', 'brand': 'BarkBox', 'source': 'verified',
     'title': '首月20%OFF', 'discount': '20% OFF'},
    {'code': 'BARKBDAY', 'brand': 'BarkBox', 'source': 'verified',
     'title': '生日月免费升级', 'discount': 'Free Upgrade'},
    ...
    {'code': 'WELCOME20', 'brand': 'TheFarmersDog', 'source': 'verified',
     'title': '全场20%OFF', 'discount': '20% OFF'},
